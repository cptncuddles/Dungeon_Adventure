#In this project I practiced alot of the skills require for OOP including defining classes, making both class, and object methods, and using specific logic to present options to the customer facing side.
# I struggled a lot with specifically definitly constructors, however things began to click when i was able to see how they work in a practical real world situation.
class Menu:
  ...
  def __repr__(self):
    return "{} is available from {} to {}".format(self.name, self.start_time, self.end_time)
...
arepas_restraunt = Business("Take a\' Arepa", [arepas_place])